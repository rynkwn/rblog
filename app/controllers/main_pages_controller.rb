class MainPagesController < ApplicationController
  ...
  # Daily Messenger Email Authorization
  #
  # Any way to make this more secure? The issue is that the input comes from outside
  ...
  # meat of the messages would be both complicated and prone to edge-cases.
  def parse_dm_email
